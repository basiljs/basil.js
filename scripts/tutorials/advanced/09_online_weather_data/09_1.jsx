...
function draw() {
  ...
  var url = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Basel&units=metric&mode=json&APPID=61f2e9b2e7a07508bdfd51cf91e132d9";
  var jsonString = loadString(url);
  var data = JSON.parse(jsonString);
  data = data.list;

  var v1 = round(map(data[0].temp.max, 0, 100, 0, 100));
  var v2 = round(map(data[0].humidity, 0, 100, 0, 100));
  var v3 = round(map(data[0].speed, 0, 100, 0, 100));
