if (!b) throw 'b is undefined, include basil.js before basil.test.js.';

b.test = (function(glob, b) {
  
  glob.assert = function(outcome, description) {
  ...
  TestRunner.prototype.run = function() {
    ...
    function runTest(testCase) {
      try {
        ...
        testResult.total++;
        if (this.spec.setUp) this.spec.setUp(b);
        this.spec[testCase](b);
      } catch(e) {
        if (e !== 'assert failed') {
        ...
        if (this.spec.tearDown) this.spec.tearDown(b);
      }
    }
  };
